...
export function ProjectsPage() {
  ...
  return <div>
    <PageHeader title="Projects" subtitle="같이 운영하는 Docker 환경, 업타임 모니터, 애플리케이션과 서버를 한곳에 묶어 상태를 확인합니다."><Button onClick={() => setEditing(null)}><MaterialIcon name="add" />추가하기</Button></PageHeader>
